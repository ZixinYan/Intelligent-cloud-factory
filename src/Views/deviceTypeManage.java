...
import Controller.deviceTypeManager;
...
public class deviceTypeManage {
	...
	public deviceTypeManage() throws FileNotFoundException, IOException {
		initialize();
	}
	...
	private void initialize() throws FileNotFoundException, IOException {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent mouseEvent) {
		        if (mouseEvent.getClickCount() == 1) {
		        	try {
		        		DefaultTableModel model = new DefaultTableModel(deviceTypeManager.getU().getDeviceData(textField.getText()),columnNames);
		...
		btnNewButton_2_1.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent mouseEvent) {
		        if (mouseEvent.getClickCount() == 1) {
		        	frame.dispose();
	        		try {
						deviceTypeManager.getU().deleteData(table,table.getSelectedRow());
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
		    ...
		    public void mouseClicked(MouseEvent mouseEvent) {
		        if (mouseEvent.getClickCount() == 1) {
                    ...
                    try {
						...
						deviceTypeManager.getU().readDataFromJTable(table);
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
                    }
		...
		modeli.setDataVector(deviceTypeManager.getU().getDeviceManager(),columnNames);
		...
		btnNewButton_2_2.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent mouseEvent) {
		        if (mouseEvent.getClickCount() == 1) {
		        	...
		        	try {
		        		editor.stopCellEditing();
						deviceTypeManager.getU().safeNew(table);
					} catch (IOException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
